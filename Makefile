...
SOURCES  = $(addprefix src/,main.c app/gui.c os/os.c os/os_impl.c base/arena.c bitmap/bitmap.c os/gfx.c cimgui/impl.cpp assets/assets.c base/string.c app/texture.c app/editor.c image/image.c fs/fs.c gfx/gfx.c) $(addprefix vendor/,log.c/src/log.c stb/impl.c)
