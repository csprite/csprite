/*
	...
	The code is 100% compatible C/C++ (just comment out << extern "C" >> in the header file)

	The windows only wchar_t UTF-16 prototypes are at the bottom of the header file
	on windows:
		- since v3.6 char is UTF-8 by default
...
/*  if you want to use UTF-8 (instead of the UTF-16/wchar_t functions at the end of tinyfiledialogs.h)
	Make sure your code is really prepared for UTF-8 (on windows, functions like fopen()
	expect MBCS and not UTF-8)
*/
